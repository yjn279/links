...
describe('Sidebar', () => {
  ...
  it('Settings item has onPress that calls onSettings and onClose', () => {
    ...
    // Settings Pressable now has onPress that calls onSettings + onClose
    ...
    expect(onClose).toHaveBeenCalledTimes(1);
    // Settings text is present in the rendered output
    const json = JSON.stringify(tree!.toJSON());
